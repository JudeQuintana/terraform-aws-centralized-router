...
- Three new validations on `previous_reachability`: schema\_version, verdict, reason.
...
| Name | Source | Version |
| ---- | ------ | ------- |
| <a name="module_this_generate_routes_to_other_vpcs"></a> [this\_generate\_routes\_to\_other\_vpcs](#module\_this\_generate\_routes\_to\_other\_vpcs) | JudeQuintana/generate-routes-to-other-vpcs/aws | 1.2.2 |
...
| [local_file.this_reachability_simplified](https://registry.terraform.io/providers/hashicorp/local/latest/docs/resources/file) | resource |
